...
class Circuit:
    ...
    # Power sensitivity: 1.0 = pure power circuit (Monza), 0.0 = pure downforce (Monaco)
    # Modifies how much power_unit vs chassis rating affects lap time.
